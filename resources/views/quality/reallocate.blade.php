...
<!--     <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7"></div> -->
    <form method="GET" action="" accept-charset="UTF-8" id="reallocation-form">
    	<div class="col-xs-6 col-sm-4 col-md-2 col-lg-2">
            {!! Form::select('project_code', $projects, Input::get('project_code'), ['id'=>'project_code', 'class'=>'form-control'])!!}
        </div>
...
{!! Form::open(['route' => 'batches.reassign', 'id' => 'reallocation-form1']) !!}
...
<div class="table-responsive top-border-table" id="users-table-wrapper">
    <table class="table" id="reallocation_table">
        <thead>
            ...
            <th class="col-sm-2">@lang('app.address')</th>
            <th class="col-sm-2">@lang('app.city')</th>
            <th class="col-sm-2">@lang('app.status')</th>
            <th class="text-center">@lang('app.action') &nbsp;
            	<input id="chkall" name="chkall" type="checkbox" value="">
            </th>
        </thead>
        <tbody>
        	@if(count($companies))
