...
class Company extends Model
{
    ...
    protected $fillable = ['batch_id','company_instructions','company_id','parent_company','company_name','address1','address2','city','state','zipcode','country','international_code','switchboardnumber','branchNumber','addresscode','website','company_email','products_services',
