...
class Upload extends Model
{
	...
	protected $fillable = ['item_id','company_instructions','company_id','parent_company','company_name','address1','address2','city','zipcode','country','international_code','switchboardnumber','branchNumber','addresscode','website','comapny_email','products_services',
